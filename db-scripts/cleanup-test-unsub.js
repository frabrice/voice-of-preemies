...
async function main() {
  ...
  const res = await client.query("DELETE FROM email_unsubscribes WHERE email = 'voiceofpreemies@gmail.com'");
  console.log('Removed test unsubscribe rows:', res.rowCount);
  await client.end();
}
